<template>
<section class="u-clearfix u-custom-color-1 u-section-1" id="carousel_c17b">
              ...
              <div class="u-layout-row">
                <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                  <div class="u-container-layout u-container-layout-1">
                    ...
                    <h6 class="u-text u-text-5">Our top services</h6>
                    <ul class="u-custom-list u-text u-text-6">
                      ...
                      <li>
                        <div class="class u-list-icon">
                          <!-- <di  v xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xml:space="preserve" class="u-svg-content">✔</div> -->
                ...
                <div class="u-form u-form-1">
                      ...
                      <div class="u-form-address u-form-group u-form-group-1">
                          <label for="address-7d20" class="u-form-control-hidden u-label">Nomor Resi</label>
                          <input type="text" placeholder="Input Nomor Resi" id="address-7d20" name="address" class="u-border-2 u-border-white u-input u-input-rectangle" required="" v-model="Services.noResi" style="::-webkit-input-placeholder { /* Edge */  color: red;}:-ms-input-placeholder { /* Internet Explorer 10-11 */  color: red;}::placeholder {  color: red;}">
                        </div>
      
                        <div class="u-form-group u-form-name">
                          <label for="name-daf4" class="u-form-control-hidden u-label">Name</label>
                          <input type="text" placeholder="Input Nama" id="name-daf4" name="name" class="u-border-2 u-border-white u-input u-input-rectangle" required="" v-model="Services.name">
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-3">
                          ...
                          <input type="tel" pattern="[+]{0,1}+[0-9]{3,15}" title="Three letter country code" placeholder="Input Nomor Telp" id="phone-966d" name="phone" class="u-border-2 u-border-white u-input u-input-rectangle" required="" v-model="Services.hp">
                        </div>
                        <div class="u-form-email u-form-group u-form-partition-factor-2">
                          <label for="email-daf4" class="u-form-control-hidden u-label">Email</label>
                          <input type="email" placeholder="Input Email" id="email-daf4" name="email" class="u-border-2 u-border-white u-input u-input-rectangle" required="" v-model="Services.email">
                        </div>
                        <div class="u-form-group u-form-message">
                          <label for="message-daf4" class="u-form-control-hidden u-label">Komplain</label>
                          <textarea placeholder="Komplain" rows="4" cols="50" id="message-daf4" name="message" class="u-border-2 u-border-white u-input u-input-rectangle" required="" v-model="Services.keterangan"></textarea>
                        </div>
                        <div class="u-form-agree u-form-group u-form-group-6">
                          ...
                          <label for="agree-2c2f" class="u-label">I accept the <a href="#">Terms of Service</a>
                          </label>
                        </div>
                        <button type="submit" v-on:click="save()" class="buttonService">
                            submit
                        </button>
    ...
    export default {
        ...
        methods:{
          ...
          save(){
            ...
            console.log("this.Services.hp",this.Services.hp);
            console.log("this.Services.email",this.Services.email);
            console.log("this.Services.noResi",this.Services.noResi);
            console.log("this.Services.keterangan",this.Services.keterangan);

            console.log("tanggal komplain",this.Services.tglKomplain)


            axios.post(`https://hirata.id:3012/api/Services`,
            {name:this.Services.name, hp: this.Services.hp, email: this.Services.email,noResi: this.Services.noResi,keterangan:this.Services.keterangan, tglKomplain:this.Services.tglKomplain })
  
            console.log("name", this.Services.name)
          },
